// 周易六十四卦数据，由 open-iching 项目整理（卦辞爻辞采用周易原文）
// 引用自 https://github.com/john-walks-slow/open-iching
const HEXAGRAMS = [
{
"id": 1,
"name": "乾",
...
const GUA_XU_GE = ["乾坤屯蒙需讼师，比小畜兮履泰否，", "同人大有谦豫随，蛊临观兮噬嗑贲，", "剥复无妄大畜颐，大过坎离三十备。", "咸恒遁兮及大壮，晋与明夷家人睽，", "蹇解损益夬姤萃，升困井革鼎震继，", "艮渐归妹丰旅巽，兑涣节兮中孚至，", "小过既济兼未济，是为下经三十四。"];

// 卦序歌逐字拼音（供首页诵读，含多音字在卦名中的正确读音）
const GE_PINYIN = {
